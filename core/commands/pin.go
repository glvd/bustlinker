...
var addPinCmd = &cmds.Command{
	...
	Arguments: []cmds.Argument{
		cmds.StringArg("link-path", true, true, "Path to object(s) to be pinned.").EnableStdin(),
	},
	Options: []cmds.Option{
...
`,
	...
	Arguments: []cmds.Argument{
		cmds.StringArg("link-path", true, true, "Path to object(s) to be unpinned.").EnableStdin(),
	},
	Options: []cmds.Option{
...
`,
	...
	Arguments: []cmds.Argument{
		cmds.StringArg("link-path", false, true, "Path to object(s) to be listed."),
	},
	Options: []cmds.Option{
